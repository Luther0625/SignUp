...
import com.example.signup_layout.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(v -> {
            ...
            if (phone.isEmpty()) {
                ...
                Toast.makeText(MainActivity.this, "Please enter your 4-digit PIN", Toast.LENGTH_SHORT).show();
            } else if (repin.length() != 4) {
                Toast.makeText(MainActivity.this, "Please re-enter your 4-digit PIN", Toast.LENGTH_SHORT).show();
            } else if (!pin.equals(repin)) {
                Toast.makeText(MainActivity.this, "PINs do not match", Toast.LENGTH_SHORT).show();
            } else if (!tAndP.isChecked()) {
                Toast.makeText(MainActivity.this, "Please agree to the terms and conditions", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(MainActivity.this, "PIN matched", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MainActivity.this, SignUp_OTP.class);
